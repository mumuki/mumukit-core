...
describe Module do
  ...
  describe '.rewrite' do
    ...
    it { expect { SomeChildClass.rewrite(:foo) {} }.to_not raise_error }
    it { expect { SomeChildClass.rewrite(:bar) {} }.to_not raise_error }
    it { expect { SomeChildClass.rewrite(:baz) {} }.to_not raise_error }
    it { expect { SomeChildClass.rewrite(:foobaz) {} }.to raise_error 'method foobaz was not previously defined here' }
